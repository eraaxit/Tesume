...
const selectImage = (e) => {
  ...
  return (
    ...
    <div className={styles.all_templates}>
      ...
      {step === 1 && <T2  name={name} currentProfession={currentProfession} educations={educations} skills={skills} experiences= {experiences} socialLinks={formContext.socialLinks} displayPicture={displayPicture} />}
