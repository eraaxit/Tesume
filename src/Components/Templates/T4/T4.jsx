                ...
                <div className={styles.lower_part}>
                    <div className={styles.left_side}>
                        ...
                        <div className={styles.links}>
                            <ul>
                                <li>
                                    <span className={styles.icon}><a href={demoProfileData.socialLinks.linkedin}> <ion-icon name="logo-linkedin"></ion-icon> </a></span><br />
                                    <span className={styles.text}>Linkedin</span>
                                </li>
                                <li>
                                    <span className={styles.icon}> <a href={demoProfileData.socialLinks.github}> <ion-icon name="logo-github"></ion-icon></a></span><br />
                                    <span className={styles.text}>Github</span>
                                </li>
                                <li>
                                    <span className={styles.icon}><a href={demoProfileData.socialLinks.phone}> <ion-icon name="call"></ion-icon></a></span><br />
                                    <span className={styles.text}>Phone</span>
                                </li>
                                <li>
                                    <span className={styles.icon}><a href={demoProfileData.socialLinks.email}> <ion-icon name="mail"></ion-icon></a></span><br />
                                    <span className={styles.text}>Email</span>
                                </li>
                                <li>
                                    <span className={styles.icon}><a href={demoProfileData.socialLinks.website}> <ion-icon name="globe"></ion-icon></a></span><br />
